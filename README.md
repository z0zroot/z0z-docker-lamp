...
To create the image `z0z/lamp`, execute the following command on the z0z-docker-lamp folder:

	docker build -t z0z/lamp .

You can now push your new image to the registry:

	docker push z0z/lamp
...
Start your image binding the external ports 80 and 3306 in all interfaces to your container:
	...
	docker run -d -p 80:80 -p 3306:3306 z0z/lamp
...
set the environment variable `MYSQL_PASS` to your specific password when running the container:
	...
	docker run -d -p 80:80 -p 3306:3306 -e MYSQL_PASS="mypass" z0z/lamp
